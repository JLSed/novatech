    ...
    <section className="flex flex-col">
        ...
        <div className="flex relative flex-col">
            ...
            <div className="absolute flex flex-col bottom-0 left-0 right-0 h-96 max-sm:h-52">
                ...
                <p className="z-10 ml-20 text-background text-wrap w-2/4 mt-2 max-sm:text-xs xl:text-lg max-sm:ml-10">At NovaTech, we connect you with top-notch tech professionals ready to elevate your issues. Whether you need virtual assistance or hands-on support, our platform is designed to meet your unique needs.</p>
        ...
        <div className="pb-56 shadow-cus1 bg-primary flex flex-col items-center xl:pt-9 ring-1 ring-thirdary max-sm:pt-20">
          <div className="flex justify-evenly w-full">
            ...
            <h1 className="text-secondary font-serif text-5xl xl:text-5xl max-sm:text-4xl text-center">Explore Our Service Offerings</h1>
            <img src={arrowDown} alt="arrow-down" className='max-sm:h-10 h-20' />
          </div>
            <p className="text-background mt-10 w-1/2 text-center max-sm:text-sm max-sm:mt-3 max-sm:w-full">We provide a wide range of tech-related services tailored to meet your needs. Whether you&apos;re looking for virtual assistance or hands-on support, we&apos;ve got you covered.</p>
