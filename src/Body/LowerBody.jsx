    ...
    <section className="bg-background pt-52 pb-24 flex flex-col justify-center items-center">
        <div className="relative self-stretch">
            <div className='absolute max-h-[500px] p-28 z-30 flex flex-col gap-10 max-sm:p-10'>
                <h1 className='font-outfit text-secondary font-bold text-6xl'>Get Started with NovaTech</h1>
                <p className='font-roboto text-background text-xl'>Join us now to access a world of tech solutions just for you.</p>
        ...
        <div className='p-14 mt-20 max-w-[2000px] max-sm:max-w-full max-sm:p-0'>
            <div className='bg-primary flex p-10 gap-5 rounded-xl max-sm:rounded-none'>
                <div className='flex flex-col gap-6 w-1/2 max-sm:w-full'>
                    <h1 className='font-outfit text-secondary font-bold text-5xl'>Unlock Your Potential and Become One of Us</h1>
                    <p className='font-roboto text-background'>Join our community of skilled freelancers ready to bring your ideas and service to life. Sign up today as our freelancer and start collaborating with top talent in the tech industry.</p>
                    <div className='flex gap-5'>
        ...
        <div className='flex flex-col gap-5 px-10'>
            <div className='flex justify-between pr-10 max-sm:flex-col'>
                <h1 className='font-poppins text-primary font-extrabold text-5xl'>Customer Feedback</h1>
                <div className='flex gap-5 h-fit'>
                    <ArrowButtonLeft shadowOn={true} />
                    <ArrowButtonRight shadowOn={true} />
                </div>
            </div>
            <p className='font-roboto text-primary'>Testimonies from our clients</p>
